...
func StartAnvilContainer(anvilStateFileName string) (testcontainers.Container, error) {
	...
	req := testcontainers.ContainerRequest{
		// nightly-3abac322efdb69e27b6fe8748b72754ae878f64d is no longer available
		// use latest stable: https://github.com/foundry-rs/foundry/pkgs/container/foundry/326174124?tag=stable
